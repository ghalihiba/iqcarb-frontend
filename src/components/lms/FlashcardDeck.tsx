    ...
    >
      ...
      >
        ...
        <div
          ...
          className="bg-white dark:bg-gray-800 rounded-2xl border-2 border-green-100 dark:border-green-800 p-8 flex flex-col items-center justify-center text-center shadow-sm"
        >
          {/* Emoji illustratif */}
          {card.emoji && (
          ...
          {/* Badge catégorie */}
          {card.categorie && (
            <span className="text-xs font-bold px-3 py-1 rounded-full bg-green-50 text-green-700 dark:bg-green-900/30 dark:text-green-300 mb-4 uppercase tracking-wide">
              {card.categorie}
            </span>
          )}
        ...
        <div
          ...
          className="bg-green-50 dark:bg-green-900/20 rounded-2xl border-2 border-green-200 dark:border-green-700 p-8 flex flex-col items-start justify-between shadow-sm"
        ...
        >
          <div className="w-full">
            ...
            {card.exemple && (
              <div className="mt-4 p-3 bg-white dark:bg-gray-800 rounded-xl border border-green-100 dark:border-green-800">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 p-8 text-center max-w-lg mx-auto">
        ...
        {categories.length > 0 && (
          <div className="flex flex-wrap gap-2 justify-center mb-8">
            {categories.map((cat) => (
              <span key={cat} className="text-xs px-3 py-1 rounded-full bg-green-50 dark:bg-green-900/20 text-green-700 dark:text-green-300 font-semibold">
                {cat}
              </span>
            ))}
          </div>
