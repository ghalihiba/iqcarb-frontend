      ...
      <main className="iq-main iq-dotgrid relative">
        ...
        <div className="iq-content">
          ...
          <div className="flex justify-end">
            <Link to="/lms" className="iq-btn-ghost text-sm">
              Parcours étudiant
            </Link>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <div className="iq-card p-5 space-y-3">
              ...
              <input value={newParcours.titre} onChange={(e) => setNewParcours((f) => ({ ...f, titre: e.target.value }))} placeholder="Titre du parcours" className="iq-input" />
              <textarea value={newParcours.description} onChange={(e) => setNewParcours((f) => ({ ...f, description: e.target.value }))} placeholder="Description" className="iq-input" />
              <button onClick={handleCreateParcours} className="iq-btn-primary text-sm">Créer parcours</button>
              <div className="pt-2">
                <select
              ...
              {selectedParcours && (
                <div className="p-3 rounded-xl bg-primary-50 dark:bg-primary-900/20 space-y-2">
                  ...
                  <textarea
                    ...
                    className="iq-input"
                  />
                  <button onClick={handleUpdateParcours} className="iq-btn-primary text-xs px-3 py-2">
              ...
              <div className="space-y-2 pt-2">
                {parcours.map((p) => (
                  <div key={p.id_parcours} className="text-sm p-3 rounded-xl iq-soft flex items-center justify-between">
                    <div>
                    ...
                    <Link to={`/lms/parcours/${p.id_parcours}`} className="text-xs px-3 py-1.5 bg-primary-50 dark:bg-primary-900/30 text-primary-700 dark:text-primary-300 rounded-lg font-semibold">Voir</Link>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="iq-card p-5 space-y-3">
              ...
              <select value={newModule.id_parcours} onChange={(e) => setNewModule((f) => ({ ...f, id_parcours: e.target.value }))} className="iq-input">
                <option value="">Sélectionner parcours</option>
                {parcours.map((p) => <option key={p.id_parcours} value={p.id_parcours}>{p.titre}</option>)}
              </select>
              <input value={newModule.titre} onChange={(e) => setNewModule((f) => ({ ...f, titre: e.target.value }))} placeholder="Titre module" className="iq-input" />
              <button onClick={handleCreateModule} className="iq-btn-primary text-sm">Créer module</button>
              <select
              ...
              {selectedModule && (
                <div className="p-3 rounded-xl iq-soft space-y-2">
                  <input
                  ...
                  <textarea
                    ...
                    className="iq-input"
                  />
                  <button onClick={handleUpdateModule} className="iq-btn-primary text-xs px-3 py-2">
                    Enregistrer module
                  </button>
                </div>
              )}

              <input value={newCours.titre} onChange={(e) => setNewCours((f) => ({ ...f, titre: e.target.value }))} placeholder="Titre cours" className="iq-input" />
              <select
              ...
              <textarea
                ...
                className="iq-input"
              />
              <button onClick={handleCreateCours} className="iq-btn-primary text-sm">Créer cours</button>
              <select
              ...
              {selectedCours && (
                <div className="p-3 rounded-xl iq-soft space-y-2">
                  ...
                  <input
                    ...
                    className="iq-input"
                  />
                  <button onClick={handleUpdateCours} className="iq-btn-primary text-xs px-3 py-2">
                    Enregistrer cours
                  </button>
                </div>
              )}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <div className="iq-card p-5 space-y-3">
              ...
              <input value={newQuiz.titre} onChange={(e) => setNewQuiz((f) => ({ ...f, titre: e.target.value }))} placeholder="Titre quiz" className="iq-input" />
              <button onClick={handleCreateQuiz} className="iq-btn-primary text-sm">Créer quiz</button>
            </div>
              ...
              {loading ? (
                ...
                <div className="space-y-2">
                  {progressionEquipe.slice(0, 8).map((row, idx) => (
                    <div key={`${row.id_utilisateur}-${idx}`} className="p-3 rounded-xl iq-soft">
